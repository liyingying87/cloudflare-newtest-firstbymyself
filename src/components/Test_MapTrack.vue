  ...
  <div id="mapTrack">
    <el-card class="box-card" shadow="never" :body-style="{ padding: '0' }">
      ...
      <div class="guijiset form-table-search">
        <div class="rowset"><label>汽车的id：</label><label>{{ vehicleNo }}</label></div>
        <div class="rowset">
          <label>开始时间：</label>
<!--          :picker-options="pickerOptions" 作用是控制时间选择的起始时间和终止时间步长等-->
          <el-date-picker size="small" v-model="startTime" type="datetime" placeholder="请选择开始时间" align="right" value-format="yyyy-MM-dd HH:mm:ss" :picker-options="pickerOptions" @change="timeChangeHandle"></el-date-picker>
        </div>
        <div class="rowset">
          <label>结束时间：</label>
          <el-date-picker size="small" v-model="endTime" type="datetime" placeholder="请选择结束时间"
            align="right" value-format="yyyy-MM-dd HH:mm:ss" :picker-options="pickerOptions" @change="timeChangeHandle"></el-date-picker>
        </div>
